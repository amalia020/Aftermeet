...
export const missionRadar: MissionRadarViewModel = {
  objective,
  nodes: [
    { id: "elena", name: "Elena", initials: "ER", x: 55, y: 25, state: "action", note: "Best move today" },
    { id: "sarah", name: "Sarah", initials: "SJ", x: 76, y: 52, state: "warm", note: "Intro opportunity" },
    { id: "david", name: "David", initials: "DC", x: 24, y: 66, state: "cooling", note: "Warmth fading" },
    { id: "marcus", name: "Marcus", initials: "MC", x: 28, y: 28, state: "waiting", note: "Hold" },
    { id: "gap", name: "Infra gap", initials: "IG", x: 62, y: 76, state: "gap", note: "Missing coverage" },
  ],
  bridges: [
